      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row md:space-x-8 text-center md:text-left mb-4 md:mb-0">
            <a href="#" className="text-gray-600 hover:text-black mb-2 md:mb-0">About Us</a>
            <a href="#" className="text-gray-600 hover:text-black mb-2 md:mb-0">Privacy Policy</a>
            <a href="#" className="text-gray-600 hover:text-black mb-2 md:mb-0">Terms of Service</a>
